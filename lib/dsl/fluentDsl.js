  ...
  function describeUseCase(jasmineDescribeFunction, describeCallbackFunction) {
    return jasmineDescribeFunction(name, function () {
      ...
      beforeAll(function () {
        ...
        _scenariooJs.default.getUseCaseContext().setDescription(_description);

        _scenariooJs.default.getUseCaseContext().addLabels(_labels);
      });
      /**
...
function scenario(name) {
  ...
  function describeScenario(jasmineItFunction, itCallbackFunction) {
    ...
    function executeCallback() {
      ...
      _scenariooJs.default.getScenarioContext().setDescription(_description2);

      _scenariooJs.default.getScenarioContext().addLabels(_labels2);
...
function step(stepCaption, additionalProperties) {
  ...
  return _scenariooJs.default.saveStep(stepCaption, additionalProperties);
}
