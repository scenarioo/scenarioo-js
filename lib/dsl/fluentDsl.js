...
function useCase(name) {
  ...
  var _description, _labels, /* properties, */pendingMessage;
...
function scenario(name, id) {

  var _description2, _labels2, /* properties, */pendingMessage;
  ...
  function describeScenario(jasmineItFunction, itCallbackFunction) {
    ...
    function executeCallback() {
      ...
      if (id) {
        _scenariooJs2.default.getScenarioContext().setId(id);
      }
...
function step(stepCaption, id, additionalProperties) {
  ...
  return _scenariooJs2.default.saveStep(id || stepCaption, additionalProperties);
}
