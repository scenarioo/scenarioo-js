...
* @constructor
*/
var FluentDsl = function FluentDsl() {
  ...
  this.useCase = function (name) {
    ...
    function describeUseCase(jasmineDescribeFunction, describeCallbackFunction) {
      ...
      return jasmineDescribeFunction(name, function () {
        ...
        beforeAll(function () {
          validateLabels('useCase', fluentDsl.dslConfig.useCaseLabels, _labels);
          scenarioo.getUseCaseContext().setDescription(_description);
          scenarioo.getUseCaseContext().addLabels(_labels);
        });
  ...
  this.scenario = function (name) {
    ...
    function describeScenario(jasmineItFunction, itCallbackFunction) {
      ...
      function executeCallback() {
        validateLabels('scenario', fluentDsl.dslConfig.scenarioLabels, _labels2);
        scenarioo.getScenarioContext().setDescription(_description2);
        scenarioo.getScenarioContext().addLabels(_labels2);
 ...
 * @type {FluentDsl}
 */
var fluentDsl = exports.fluentDsl = new FluentDsl();
