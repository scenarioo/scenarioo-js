...
function describeScenario(jasmineItFunction, scenarioName, scenarioDescription, callback) {
  ...
  // we have to wrap our scenario with a "describe" in order to get a suite,
  // where we can access the parent which is our current useCase
  var jasmineSuite = describe('', function () {
...
var scenariooJs = {
   ...
   */
  saveStep: scenarioDocuWriter.saveStep,
