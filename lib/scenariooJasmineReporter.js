...
function ScenariooJasmineReporter(targetDirectory) {
...
ScenariooJasmineReporter.prototype.reportRunnerStarting = function (runner) {
    ...
    var suites = runner.topLevelSuites(), absoluteTargetDir = path.resolve(this.targetDirecotry);
    ...
    ScenarioDocuWriter.start(branch, build, absoluteTargetDir);
};
