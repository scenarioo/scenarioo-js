...
function getPageNameFromUrl(url) {
  var pageName = url;
  if (_.isFunction(ScenarioDocuWriter.pageNameFunction)) {
    pageName = ScenarioDocuWriter.pageNameFunction(url);
  }
  return  utils.sanitizeIdentifier(pageName);
}
...
var ScenarioDocuWriter = {
   ...
   * Scenarioo will pass in the page's full url.
   */
  registerPageNameFunction: function (pageNameFunction) {
    this.pageNameFunction = pageNameFunction;
  },
