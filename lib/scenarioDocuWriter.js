...
function increaseAndGetStepCounter() {
    if (utils.isDefined(jasmine.scoEnv.currentScenario.stepCounter)) {
        jasmine.scoEnv.currentScenario.stepCounter++;
    } else {
        jasmine.scoEnv.currentScenario.stepCounter = 0;
    }
    return jasmine.scoEnv.currentScenario.stepCounter;
}
...
function getCurrentScenario() {
    return {
        useCaseName: jasmine.scoEnv.currentUseCase.description,
        scenarioName: jasmine.scoEnv.currentScenario.description,
