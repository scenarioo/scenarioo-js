...
function runStarted(options) {
  ...
  _docuWriter2.default.start(_scenariooStore2.default.getBranch(), _scenariooStore2.default.getBuild().name, absoluteTargetDir);
...
function expectationFailed(options, failureMessage) {
  ...
  if (options.reportStepOnExpectationFailed) {
    _scenariooJs2.default.saveStep('Error: ' + failureMessage, { status: 'failed', labels: ['error'] });
  }
}
