 ...
 */
useCase('Example Use Case with Fluent DSL', 'example-use-case-with-fluent-dsl')
    .description('An optional but recommended description for the use case')
    .labels(['example-custom-label'])
    .properties([{
        // TODO: allow easy property generation using factory/helper
        labelKey: 'myKey',
        value: 'some value'
    }])
    .describe(function () {
         ...
         */
        scenario('Example Scenario with Fluent DSL', 'example-scenario-with-fluent-dsl')
            ...
            .it(function () {
                ...
                // TODO: {step} step = step(title, [id], [additionalProperties]);
                var step = step('browse to start page', 'id');
                step.page = {};
                step.visibleText = 'blabla';
                step.labels = ['label-1', 'label-2'];
                // or step.addSceenAnnotation({});
                step.screenAnnotations = [{
                    style: 'CLICK',
                    clickAction: 'TO_URL',
                ...
                step.addProperties([{}]);
                step.addSection('some section title', sectionProperties);
